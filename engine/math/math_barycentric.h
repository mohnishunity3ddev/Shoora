...
// TODO: NOT TESTED
vec3f BarycentricCramersMethod(const shu::vec3f &A, const shu::vec3f &B, const shu::vec3f &C, const vec3f &P);
vec3f BarycentricProjectionMethod(const shu::vec3f &A, const shu::vec3f &B, const shu::vec3f &C, const vec3f &P);
vec3f BarycentricCrossMethod(const shu::vec3f &A, const shu::vec3f &B, const shu::vec3f &C, const vec3f &P);
