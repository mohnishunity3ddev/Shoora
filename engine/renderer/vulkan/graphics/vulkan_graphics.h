...
struct shoora_graphics
{
    ...
    static void DrawCubeWireframe(const shu::vec3f &v000, const shu::vec3f &v100, const shu::vec3f &v110,
                                  ...
                                  f32 Thickness = 0.01f);
    static void DrawTriangle(const shu::vec3f &A, const shu::vec3f &B, const shu::vec3f &C, u32 ColorU32);
    static void DrawTetrahedron(const shu::vec3f &A, const shu::vec3f &B, const shu::vec3f &C, const shu::vec3f &D,
                                u32 triColorA, u32 triColorB, u32 triColorC, u32 triColorD);

    static void DrawLine3D(const shu::vec3f &P0, const shu::vec3f &P1, u32 ColorU32 = colorU32::Green,
                           f32 Thickness = 0.05f);
