...
namespace shu::interp
{
    ...
    shox_token::shox_token(shox_token_type type, const char *lexeme, const shox_token_data &data, i32 line)
    {
        this->type = type;
        this->line = line;
        SHU_MEMCOPY(lexeme, this->lexeme, 128);
    ...
    shox_token::ToString(char *str)
    {
        ...
        LogWarnUnformatted("[shox_token::to_string()]: Free this Memory!");
        return (char *)memory;
    }
